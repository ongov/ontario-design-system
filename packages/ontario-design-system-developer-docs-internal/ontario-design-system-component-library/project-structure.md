...
This project follows a standard StencilJS component library setup, with a few additional scripts and folders specific to our build process. Below is an overview of the key folders and files in the project:
...
- **Component Directory**: Each component has its own subfolder containing:
  ...
  - **Style File (_component-name.scss_)**: The component-specific styles, written in SCSS. This file defines the appearance of the component and uses the BEM methodology for class naming, and variables from the global styles package for styling.
...
- It gathers all `.scss` files in the _styles/slotted-styles_ folder.
