...
- Clone the main [GitHub repository](https://github.com/ongov/ontario-design-system) and follow the setup guide.
...
As part of the development workflow there are two main branches, `master` and `develop`.
...
- Ensure your branch is up to date with the `develop` branch (unless one is working on a hotfix in which case start off of `master`).
