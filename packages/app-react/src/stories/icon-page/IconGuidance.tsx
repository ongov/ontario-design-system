		...
		<>
			...
			<div className="ontario-row">
				<div className="ontario-columns ontario-medium-12 ontario-large-12">
					...
					<p>
            Icons are a visual representation of a <strong>single and simple object, action or idea</strong>. If you need to communicate more complicated concepts, consider an illustration or infographic.
					</p>
          ...
          <p>Please let the design system team know any time you need an icon that isn’t in our icon library. If we find the same ones are being commonly used, we’ll consider adding them to the library.</p>
					<hr />
