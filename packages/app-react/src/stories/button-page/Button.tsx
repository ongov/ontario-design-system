			...
			<div className="ontario-row">
				...
				<div className="ontario-row">
					<div className="ontario-columns ontario-medium-12 ontario-large-12">
						...
						download a PDF Don’t use a button when you’re not encouraging an action. Buttons should not be used the same way as links, which usually send the user to another page
						or to a different part of the same page. Types of buttons Use a primary button to draw attention to the main action you want to help the user take. Avoid using multiple
						...
						multiple secondary buttons so the user is not confused about what they should do next. Instead, ask the writer to simplify or break up the content so that it doesn’t
						need multiple secondary buttons. Use tertiary buttons for links that should function like a butto
					</div>
				</div>
			</div>
		</div>
