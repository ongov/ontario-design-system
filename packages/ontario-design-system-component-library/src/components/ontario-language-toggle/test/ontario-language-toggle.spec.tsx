...
describe('ontario-language-toggle', () => {
	describe('snapshot', () => {
		it('should render the expected html', async () => {
			const page = await render(`<ontario-language-toggle></ontario-language-toggle>`);
...
<ontario-language-toggle class="hydrated">
  <mock:shadow-root>
...
`);
	...
	it('should render a small size language toggle with a French default language when explicitly specified', async () => {
		const page = await render(
			`<ontario-language-toggle size="small" url="/en" language="fr"></ontario-language-toggle>`,
		);

		expect(page.root).toEqualHtml(`
<ontario-language-toggle size="small" url="/en" language="fr" class="hydrated">
  <mock:shadow-root>
