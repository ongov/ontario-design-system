...
/**
 * Ontario Input component properties
 */
export interface OntarioInputProperties {
	/**
...
export class OntarioInput implements OntarioInputProperties {
	/**
	 * The aria-describedBy value if the input has hint text associated with it.
	 */
	...
	componentWillLoad() {
		this.inputId = this.inputId ?? uuid();
	}
