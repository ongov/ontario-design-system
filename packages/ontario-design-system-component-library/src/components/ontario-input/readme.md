...
| `labelFor`     | `label-for`     | The form control with which the caption is associated.                                                         | `string`                                                                                                                                    | `undefined` |
...
| `required`     | `required`      | Used to define whether the input field is required or not. If required, the value passed should be 'required'. | `boolean`                                                                                                                                   | `false`     |
