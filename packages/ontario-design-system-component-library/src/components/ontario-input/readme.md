...
| `inputId`     | `id`           | The unique identifier of the input. If no ID is passed, one will be autogenerated.                             | `string \| undefined`                                                                                                                                    | `undefined` |
...
| `value`       | `value`        | The input content value.                                                                                       | `null \| string \| undefined`                                                                                                                            | `undefined` |
