...
By default, the Back to Top button will have it's language set to English ('en'). However, a property can be passed to set the language to French by default. For example:

```html
<ontario-back-to-top language="fr" />
```

Otherwise, a default Back to Top button can be used as following:
