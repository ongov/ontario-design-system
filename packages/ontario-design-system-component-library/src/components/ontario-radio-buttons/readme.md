...
| `customOnBlur`   | --              | Used to add a custom function to the radio input onBlur event.                                                                                                                                                                                                                                                                                                                                                                                 | `((event: Event) => never) \| undefined` | `undefined` |
| `customOnChange` | --              | Used to add a custom function to the radio input onChange event.                                                                                                                                                                                                                                                                                                                                                                               | `((event: Event) => never) \| undefined` | `undefined` |
| `customOnFocus`  | --              | Used to add a custom function to the radio input onFocus event.                                                                                                                                                                                                                                                                                                                                                                                | `((event: Event) => never) \| undefined` | `undefined` |
...
| --------------- | ----------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| `radioOnBlur`   | Emitted when a keyboard input event occurs when a radio option has lost focus.            | `CustomEvent<InputChangeEvent & { focused: boolean; }>` |
| `radioOnChange` | Emitted when a keyboard input or mouse event occurs when a radio option has been changed. | `CustomEvent<InputChangeEvent & { checked: boolean; }>` |
| `radioOnFocus`  | Emitted when a keyboard input event occurs when a radio option has gained focus.          | `CustomEvent<InputChangeEvent & { focused: boolean; }>` |
