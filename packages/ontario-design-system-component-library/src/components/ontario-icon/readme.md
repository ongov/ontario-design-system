...
| ----------- | ------------ | ------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ------------------ |
| `colour`    | `colour`     | Set the icon's colour. Note that some icon's colour cannot be changed.                                              | `IconColour.black \| IconColour.blue \| IconColour.grey \| IconColour.white` | `IconColour.black` |
