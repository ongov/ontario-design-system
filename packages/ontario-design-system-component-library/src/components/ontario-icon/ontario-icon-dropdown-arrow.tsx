...
export class OntarioIconDropdownArrow implements IconWithColour {
	/**
	...
	render() {
		return (
			<div
				class={`ontario-icon ontario-icon--width-${this.iconWidthState} ontario-icon--${this.iconColourState}`}
