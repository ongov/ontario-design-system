...
@Component({
	tag: 'ontario-icon-sort-alphabetical-ascending',
	styleUrl: 'ontario-icon.scss',
	shadow: true,
})
export class OntarioIconSortAlphabeticalAscending implements IconWithColour {
	/**
	...
	validateWidth() {
		if (isNaN(this.iconWidth) || (!isNaN(this.iconWidth) && this.iconWidth <= 0)) {
			...
			message
				...
				.addRegularText('on')
				.addMonospaceText(' <ontario-icon-sort-alphabetical-ascending> ')
				.addRegularText(
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-sort-alphabetical-ascending>',
	...
	render() {
		return (
			...
			>
				...
				>
					<path d="M19 17H22L18 21L14 17H17V3H19M11 13V15L7.67 19H11V21H5V19L8.33 15H5V13M9 3H7C5.9 3 5 3.9 5 5V11H7V9H9V11H11V5C11 3.9 10.11 3 9 3ZM9 7H7V5H9V7Z" />
				</svg>
			</div>
		);
	}
