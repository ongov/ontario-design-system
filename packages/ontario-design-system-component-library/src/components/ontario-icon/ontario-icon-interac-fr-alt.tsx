...
export class OntarioIconInteracFrAlt implements Icon {
    ...
    validateWidth() {
        ...
        {
            message: `%c <ontario-icon-interac-fr-alt> `,
            style: MessageStyle.CODE,
        },
        {
