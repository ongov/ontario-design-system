...
export class OntarioIconVoteDislike implements IconWithColour {
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-vote-dislike>',
		...
		return (
			...
			>
				<svg
					...
					id="vote-dislike"
				>
					<path d="M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.1.23-.14.47-.14.73v2c0 1.1.9 2 2 2h6.3l-.95 4.57-.03.32c0 .4.17.8.44 1.06L9.83 23l6.6-6.6c.36-.36.58-.86.58-1.4V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z" />
				</svg>
			</div>
		);
	}
