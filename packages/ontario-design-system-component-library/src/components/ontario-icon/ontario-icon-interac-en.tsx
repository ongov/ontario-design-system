...
export class OntarioIconInteracEn implements Icon {
    ...
    validateWidth() {
        ...
        {
            message: `%c <ontario-icon-interac-en> `,
            style: MessageStyle.Code,
        },
        {
