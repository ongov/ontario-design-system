	...
	describe('snapshot', () => {
		it('should render the expected html', async () => {
			const page = await render(
				`<ontario-icon-accessibility icon-width="36" colour="grey"></ontario-icon-accessibility>`,
			);
...
<ontario-icon-accessibility icon-width="36" colour="grey" class="hydrated">
  <mock:shadow-root>
    <div class="ontario-icon ontario-icon--grey ontario-icon--width-36">
      <svg class="svg-icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="accessibility">
...
`);
	...
	it('renders a decorative chevron-up icon without being focusable', async () => {
		const page = await render(
			`<ontario-icon-chevron-up icon-width="36" colour="grey" is-decorative="true"></ontario-icon-chevron-up>`,
		);

		expect(page.root).toEqualHtml(`
<ontario-icon-chevron-up icon-width="36" colour="grey" is-decorative="true" class="hydrated">
  <mock:shadow-root>
    <div class="ontario-icon ontario-icon--grey ontario-icon--width-36">
...
`);
	...
	it('renders a decorative chevron-down icon without being focusable', async () => {
		const page = await render(
			`<ontario-icon-chevron-down icon-width="36" colour="grey" is-decorative="true"></ontario-icon-chevron-down>`,
		);

		expect(page.root).toEqualHtml(`
<ontario-icon-chevron-down icon-width="36" colour="grey" is-decorative="true" class="hydrated">
  <mock:shadow-root>
    <div class="ontario-icon ontario-icon--grey ontario-icon--width-36">
