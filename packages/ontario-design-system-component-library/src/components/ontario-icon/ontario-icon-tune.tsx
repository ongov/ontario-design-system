...
@Component({
	tag: 'ontario-icon-tune',
	styleUrl: 'ontario-icon.scss',
	shadow: true,
})
export class OntarioIconTune implements IconWithColour {
	/**
	...
	validateWidth() {
		if (isNaN(this.iconWidth) || (!isNaN(this.iconWidth) && this.iconWidth <= 0)) {
			...
			message
				...
				.addRegularText('on')
				.addMonospaceText(' <ontario-icon-tune> ')
				.addRegularText(
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-tune>',
	...
	render() {
		return (
			...
			>
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" id="tune">
