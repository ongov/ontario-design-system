		...
		return (
			...
			>
				<svg
					...
					viewBox="0 0 24 24"
					id="mastercard"><circle cx="8" cy="12" r="6.5" fill="#eb001b"/><circle cx="16" cy="12" r="6.5" fill="#f79e1b"/
				>
					<path d="M12 17.124S9.5 15.5 9.5 12 12 6.876 12 6.876 14.5 8.5 14.5 12 12 17.124 12 17.124z" fill="#ff5f00"/
				>
					<path d="M21.173 16.85v-.3h.125v-.06H21v.06h.117v.3h.055zm.578 0v-.35h-.1l-.105.25-.105-.25h-.1v.35h.065v-.265l.098.227h.067l.098-.227v.265h.063z" fill="#f79e1b"/><g fill="#231f20"
				>
				...
				>
					<path d="M22.335 21.79c.017-.001.033.002.047.012.005.005.01.01.013.017s.004.014.003.02c-.005.023-.008.028-.013.032-.01.01-.024.015-.038.016l.052.06h-.04l-.048-.06h-.016v.06h-.034v-.158h.075zm-.04.03v.043h.04c.012 0 .023.002.023-.008v-.023c0-.01-.002-.013-.023-.012h-.04z"/></g>
				</svg>
			</div>
		);
	}
