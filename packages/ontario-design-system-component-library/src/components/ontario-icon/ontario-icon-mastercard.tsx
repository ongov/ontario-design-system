...
export class OntarioIconMastercard implements Icon {
    ...
    validateWidth() {
        ...
        {
            message: `%c <ontario-icon-mastercard> `,
            style: MessageStyle.Code,
        },
        {
