...
const getIconComponentTemplate = (svgObject, iconName) => {
    ...
    if (hasColour) {
      svgElement = svgElement.replace(customColourRegex, 'class="svg-icon" style={{ fill: `${this.iconCustomColourState}`, stroke: `${this.iconCustomColourState}`}}');
    }
...
import { validateValueAgainstArray } from '../../utils/validation/validation-functions';` : ''} ${hasColour ? `
