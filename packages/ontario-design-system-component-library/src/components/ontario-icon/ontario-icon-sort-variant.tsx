...
@Component({
	tag: 'ontario-icon-sort-variant',
	styleUrl: 'ontario-icon.scss',
	shadow: true,
})
export class OntarioIconSortVariant implements IconWithColour {
	/**
	...
	validateWidth() {
		if (isNaN(this.iconWidth) || (!isNaN(this.iconWidth) && this.iconWidth <= 0)) {
			...
			message
				...
				.addRegularText('on')
				.addMonospaceText(' <ontario-icon-sort-variant> ')
				.addRegularText(
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-sort-variant>',
