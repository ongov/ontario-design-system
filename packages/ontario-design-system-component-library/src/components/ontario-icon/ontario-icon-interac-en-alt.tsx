...
export class OntarioIconInteracEnAlt implements Icon {
    ...
    validateWidth() {
        ...
        {
            message: `%c <ontario-icon-interac-en-alt> `,
            style: MessageStyle.CODE,
        },
        {
