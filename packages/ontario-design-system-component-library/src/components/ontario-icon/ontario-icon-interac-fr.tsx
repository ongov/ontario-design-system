...
export class OntarioIconInteracFr implements Icon {
    /**
    ...
    validateWidth() {
        ...
        {
            message: `%c <ontario-icon-interac-fr> `,
            style: MessageStyle.CODE,
        },
        {
