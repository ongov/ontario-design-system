...
export class OntarioIconAccount implements IconWithColour {
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-account>',
		...
		return (
			...
			>
				<svg
					...
					id="account"
				>
					<path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2a7.2 7.2 0 0 1-6-3.22c.03-2 4-3.08 6-3.08 2 0 5.97 1.1 6 3.08a7.2 7.2 0 0 1-6 3.22z" />
				</svg>
			</div>
		);
	}
