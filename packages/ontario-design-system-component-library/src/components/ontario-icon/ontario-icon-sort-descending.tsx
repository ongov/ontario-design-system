...
@Component({
	tag: 'ontario-icon-sort-descending',
	styleUrl: 'ontario-icon.scss',
	shadow: true,
})
export class OntarioIconSortDescending implements IconWithColour {
	/**
	...
	validateWidth() {
		if (isNaN(this.iconWidth) || (!isNaN(this.iconWidth) && this.iconWidth <= 0)) {
			...
			message
				...
				.addRegularText('on')
				.addMonospaceText(' <ontario-icon-sort-descending> ')
				.addRegularText(
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-sort-descending>',
