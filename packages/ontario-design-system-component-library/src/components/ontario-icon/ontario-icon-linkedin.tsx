...
export class OntarioIconLinkedin implements IconWithColour {
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-linkedin>',
		...
		return (
			...
			>
				<svg
					...
					id="linkedin"
				>
					<path d="M21 21h-4v-6.75c0-1.06-1.2-1.94-2.25-1.94S13 13.2 13 14.25V21H9V9h4v2c.66-1.07 2.36-1.76 3.5-1.76a4.51 4.51 0 0 1 4.5 4.51V21zM7 21H3V9h4v12zM5 3a2 2 0 0 1 2 2 2 2 0 0 1-2 2 2 2 0 0 1-2-2 2 2 0 0 1 2-2z" />
				</svg>
			</div>
		);
	}
