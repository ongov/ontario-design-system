...
export class OntarioIconExport implements IconWithColour {
	...
	private warnDefaultColour(): IconColour {
		printInvalidPropWarning({
			propName: 'colour',
			componentTag: '<ontario-icon-export>',
		...
		return (
			...
			>
				<svg
					...
					id="export"
				>
					<path d="M19 12v7H5v-7H3v7c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7h-2zm-6 .67l2.6-2.58 1.4 1.4-5 5-5-5 1.4-1.4 2.6 2.58V3h2v9.67z" />
				</svg>
			</div>
		);
	}
