import { Component, Prop, Element, State, h, Listen, Watch, Fragment } from '@stencil/core';
import { Accordion } from '../ontario-accordion/accordion.interface';
import { ExpandCollapseButtonDetails } from '../ontario-accordion/expandCollapseButtonDetails.interface';
import { Language } from '../../utils/common/language-types';
import { validateLanguage } from '../../utils/validation/validation-functions';
import translations from '../../translations/global.i18n.json';

@Component({
	tag: 'ontario-accordion-two',
...
export class OntarioAccordionTwo {
	...
	@State() sections: HTMLOntarioAccordionSectionElement[];
	...
	componentWillLoad() {
		...
		// Get sections
		this.sections = Array.from(this.host.querySelectorAll('ontario-accordion-section'));
		...
		return (
			<div>
				...
				<div class="ontario-accordions__container">
					...
					{this.sections.map((s) => (
						<section
							class={`ontario-accordion__content ontario-accordion__content--opened'`}
							data-toggle="ontario-expander-content"
						>
							(<div innerHTML={s.outerHTML}></div>)
						</section>
					))}
					{/* {this.sections.map((s) => (
						<Fragment>
