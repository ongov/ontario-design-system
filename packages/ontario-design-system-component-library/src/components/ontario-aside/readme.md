...
## Technical Note: Content Rendering and SSR
...
> Recommended for SSR:  
> `<ontario-aside headingContent="Notice" content="This is the callout content." />`

> Slotted content may not render in SSR:  
> `<ontario-aside headingContent="Notice"><p>This won't appear on the server</p></ontario-aside>`
...
| `headingContent`     | `heading-content`      | Text or HTML to be displayed as the heading of the aside. If the heading content should be displayed as HTML, the `headingContentType` needs to be set to `html`.                                                                                                                          | `string \| undefined`                                                                                      | `undefined` |
...
| `headingType`        | `heading-type`         | The heading level of the aside heading.                                                                                                                                                                                                                                                    | `"h2" \| "h3" \| "h4" \| "h5" \| "h6" \| undefined`                                                        | `undefined` |
