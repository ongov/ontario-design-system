	...
	it('should render a default hint expander', async () => {
      ...
      <ontario-hint-expander hint="This is the hint" content="This is the content" element-id="elementId" aria-controls="hint-expander-controls">
        ...
        <div class="ontario-hint-expander__container">
          ...
          >
            <span class="ontario-hint-expander__button-icon--close ontario-icon"><ontario-icon-chevron-up colour="inherit" is-decorative="true"></ontario-icon-chevron-up></span>
            <span class="ontario-hint-expander__button-icon--open"><ontario-icon-chevron-down colour="inherit" is-decorative="true"></ontario-icon-chevron-down></span>
            This is the hint
          </button>
