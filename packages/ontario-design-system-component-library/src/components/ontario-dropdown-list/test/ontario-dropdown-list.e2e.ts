...
describe('ontario-dropdown-list', () => {
  ...
  describe('render changes', () => {
    ...
    beforeEach(async () => {
      ...
      await page.setContent("<ontario-dropdown-list label='Do you like cats?' name='cat-dropdown' is-required is-empty-start-option='Please select'></ontario-dropdown-list>");
