...
| `isRequired`         | `is-required`           | Determine whether the dropdown list is required. If required, add `is-required` attribute. Otherwise, the `optional` flag will appear.                                                                                                                                                                       | `boolean`                        | `false`     |
