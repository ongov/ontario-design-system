...
| `signInMenuItems`       | `sign-in-menu-items`      | Information pertaining to the sign-in menu items for the Ontario header.                                                                                                                                                                               | `OntarioSignInMenuItems[] \| string \| undefined`             | `undefined`     |
