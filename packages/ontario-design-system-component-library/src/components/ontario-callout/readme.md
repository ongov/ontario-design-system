...
| `headingContent`     | `heading-content`      | Text or HTML to be displayed as the heading of the callout. If the heading content needs to be displayed as HTML, the `headingContentType` needs to be set to html.                                                                                                                            | `string`                                                                                                   | `undefined` |
