...
| --------------- | ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------- | ------------------------------------ |
| `accordionData` | `accordion-data`  | Used to include individual accordion data for the accordion component. This is passed in as an array of objects with key-value pairs. The `content` is expecting an array of strings to populate the `<ul>` element within each individual accordion. `	<ontario-accordion 	name="My Accordion" 	accordion-data='[ 		{"label": "Accordion 1", "content": ["Item 1", "Item 2", "Item 3"]}, 		{"label": "Accordion 2", "content": ["Item A", "Item B", "Item C"]} 	]'` ></ontario-accordion> | `Accordion[] \| string` | `undefined`                          |
| `ariaLabelText` | `aria-label-text` | The alt text for the expand/close button.                                                                                                                                                                                                                                                                                                                                                                                                                                          | `string`                | `'Expand or collapse the accordion'` |
| `closeLabel`    | `close-label`     | The label for the 'Collapse all' button. ` <ontario-accordion 	name="My Accordion" 	open-label="Expand all" 	close-label="Collapse all" 	accordion-data='[ 		{"label": "Accordion 1", "content": ["Item 1", "Item 2", "Item 3"]}, 		{"label": "Accordion 2", "content": ["Item A", "Item B", "Item C"]} 	]' ></ontario-accordion>`                                                                                                                                                          | `string`                | `'Collapse All'`                     |
| `isOpen`        | `is-open`         |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `boolean`               | `false`                              |
| `name`          | `name`            | The name of the accordion component. This is not optional.                                                                                                                                                                                                                                                                                                                                                                                                                         | `string`                | `undefined`                          |
| `openLabel`     | `open-label`      | The label for the 'Expand all' button. ` <ontario-accordion 	name="My Accordion" 	open-label="Expand all" 	close-label="Collapse all" 	accordion-data='[ 		{"label": "Accordion 1", "content": ["Item 1", "Item 2", "Item 3"]}, 		{"label": "Accordion 2", "content": ["Item A", "Item B", "Item C"]} 	]' ></ontario-accordion>`                                                                                                                                                            | `string`                | `'Expand All'`                       |
