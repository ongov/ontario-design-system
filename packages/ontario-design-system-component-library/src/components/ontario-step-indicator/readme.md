...
| -------------------- | --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------- | ----------- |
| `backButtonLink`     | `back-button-link`    | Link for the back button onClick function.                                                                                                                                                                    | `string \| undefined`       | `undefined` |
| `currentStep`        | `current-step`        | Lets user know which step the current page is on.                                                                                                                                                             | `number \| undefined`       | `1`         |
| `customOnClick`      | --                    | Used to add a custom function to the back button onClick event.                                                                                                                                               | `Function \| undefined`     | `undefined` |
