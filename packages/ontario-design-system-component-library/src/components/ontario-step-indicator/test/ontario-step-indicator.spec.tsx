...
describe('ontario-step-indicator', () => {
	...
	it('renders the expected step output shape', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders the expected percentage and back-link output shape', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders step mode by default', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
			html: `<ontario-step-indicator></ontario-step-indicator>`,
		});
	...
	it('renders percentage mode when percentageComplete is defined', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders percentage mode when percentageComplete is 0', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('warns and prefers percentage mode when percentage and step props are mixed', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders step mode with a placeholder and warns when currentStep is missing', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders step mode with a placeholder and warns when numberOfSteps is missing', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders a back link when backButtonUrl is provided', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('renders a back button when only customOnClick is provided', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
			html: `<ontario-step-indicator current-step="2" number-of-steps="5"></ontario-step-indicator>`,
		});
	...
	it('warns when rendering a back button without backButtonUrl or customOnClick', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
	...
	it('warns and prefers the anchor when backButtonUrl and customOnClick are both provided', async () => {
		const page = await newSpecPage({
			components: [OntarioStepIndicator],
			html: `<ontario-step-indicator show-back-button="true" back-button-url="https://designsystem.ontario.ca/" current-step="2" number-of-steps="5"></ontario-step-indicator>`,
		});
