...
| `headerColour`                | `header-colour`                  | Set the card's header colour. This is optional.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `"blue" \| "green" \| "magenta" \| "red" \| "yellow" \| "teal" \| "gold" \| "taupe" \| "lime" \| "sky" \| "purple" \| "light-teal" \| "dark-accent" \| "light-accent" \| "light-gold" \| "light-yellow" \| "light-taupe" \| "light-green" \| "light-lime" \| "light-sky" \| "light-blue" \| "light-purple" \| "light-orange" \| "light-red" \| "light-magenta" \| "orange" \| undefined` | `undefined`   |
