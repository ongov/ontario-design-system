...
| `headingLevel`                | `heading-level`                  | Text to be displayed within the header.                                                                                                                                                                                                                                                                                        | `string`                                   | `"h2"`        |
...
| `imageAltText`                | `image-alt-text`                 | Alt text for the card's image. This is optional prop, but may be required for an image due to accessibility requirements. You can find guidance on when to add alt text to an image on the Ontario.ca web content editing guide. https://www.ontario.ca/page/ontario-ca-web-content-editing-guide#alt-text-image-accessibility | `string \| undefined`                      | `''`          |
