...
| `headerColour`                | `header-colour`                  | Set the card's header colour. This is optional.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | `"blue" \| "teal" \| "gold" \| "yellow" \| "taupe" \| "green" \| "lime" \| "sky" \| "purple" \| "red" \| "lightTeal" \| "darkAccent" \| "lightAccent" \| "lightGold" \| "lightYellow" \| "lightTaupe" \| "lightGreen" \| "lightLime" \| "lightSky" \| "lightBlue" \| "lightPurple" \| "lightOrange" \| "lightRed" \| "lightMagenta" \| "orange" \| "magenta" \| undefined` | `undefined`   |
