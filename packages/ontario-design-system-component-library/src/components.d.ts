...
import { HeadingLevelOptions, HighlightColourOptions } from './utils/callout-aside/callout-aside.interface';
...
export namespace Components {
	interface OntarioAside {
		/**
		 * Optional text to be displayed as the content for the aside component. If a string is passed, it will automatically be nested in a paragraph tag.  HTML content can also be passed as the either child/children of the aside component if additional/different elements for the content are needed, or through the `content` prop.
	...
	interface OntarioCallout {
		/**
		 * Optional text to be displayed as the content for the callout component. If a string is passed, it will automatically be nested in a paragraph tag.  HTML content can also be passed as either the child/children of the callout component if additional/different elements for the content are needed, or through the `content` prop.
	...
	interface OntarioInput {
		...
		elementId?: string;
		/**
		 * Used to include the Hint Expander component underneath the input box. This is passed in as an object with key-value pairs. This is optional.
	...
	interface OntarioTextarea {
		...
		elementId?: string;
		/**
		 * Used to include the Hint Expander component for the textarea. This is passed in as an object with key-value pairs. This is optional.
