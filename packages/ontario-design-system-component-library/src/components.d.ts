...
import { CardType, HeaderColour, HorizontalImagePositionType, HorizontalImageSizeType } from "./components/ontario-card/ontario-card-types";
...
export { CardType, HeaderColour, HorizontalImagePositionType, HorizontalImageSizeType } from "./components/ontario-card/ontario-card-types";
