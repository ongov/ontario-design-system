...
export namespace Components {
    ...
    interface OntarioHeaderOverflowMenu {
        ...
        /**
          ...
          * @example <ontario-header-overflow-menu   menu-items='[{     "title": "Link 1",     "href": "/link-1",     "linkIsActive": "false"   },{     "title": "Link 2",     "href": "/link-2",     "linkIsActive": "false"   }]'   sign-in-menu-items='[{     "title": "Sign in to your account",     "href": "/sign-in",     "description": "Access your personal information"   },{     "title": "Create an account",     "href": "/register",     "description": "Register for government services"   }]'   header-type="ontario"   breakpoint-state="mobile"> </ontario-header-overflow-menu>
         */
        "signInMenuItems"?: MenuItem[] | string;
    }
