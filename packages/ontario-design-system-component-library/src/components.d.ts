...
export namespace Components {
    ...
    interface OntarioInput {
        ...
        "caption": Caption | string;
        /**
          * The aria-describedBy value if the input has hint text associated with it.  Note that this will only apply if the user is including hint text separately from the built in version of this component.
         */
        "describedBy"?: string;
        /**
