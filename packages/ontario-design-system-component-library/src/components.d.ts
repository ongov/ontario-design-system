...
import { RadioOption } from "./components/ontario-radio-button/radio-option.interface";
export namespace Components {
    ...
    interface OntarioRadioButtons {
        ...
        "legend": string;
        /**
          * The name assigned to the radio button. The name value is used to reference form data after a form is submitted. Please note that if you have multiple radio button options, the name must the same for all options in a fieldset.
         */
        "name": string;
        /**
