...
@ProxyCmp({
  inputs: ['ariaLabelText', 'cardLink', 'cardType', 'description', 'headerType', 'horizontalImagePositionType', 'horizontalImageSizeType', 'image', 'label']
})
@Component({
...
@ProxyCmp({
  inputs: ['applicationHeaderInfo', 'assetBasePath', 'customLanguageToggle', 'disableDynamicMenu', 'language', 'languageToggleOptions', 'menuItems', 'type']
})
@Component({
